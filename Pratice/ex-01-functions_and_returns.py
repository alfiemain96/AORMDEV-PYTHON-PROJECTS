...
def operation_type_select(choose_operation, first_variable, second_variable):
...
def print_result(first_variable, second_variable, choose_operation,operation_result):
    if choose_operation == 1:
